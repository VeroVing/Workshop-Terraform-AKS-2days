...
terraform {
  ...
  backend "azurerm" {
    resource_group_name  = "weuvvmrsgaks00"         # mettre ici le nom du resource group de vos ressource
    storage_account_name = "weuvvmstotfof00"      # mettre le nom du compte de stockage créer dans le lab 1
